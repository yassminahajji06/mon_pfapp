...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<MenuItem> get _popularItems {
    final byCategory = DemoData.menuItems.where((item) => item.category == _selectedCategory).toList();
    return byCategory.isEmpty ? DemoData.menuItems.where((item) => item.popular).toList() : byCategory;
  }
            ...
            child: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.location_on_outlined, color: Color(0xFFFFCDD2), size: 16),
        ...
        child: Row(
          children: [
            const Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    'Offre du jour',
                    style: TextStyle(color: Color(0xFFFFCDD2), fontSize: 12, fontWeight: FontWeight.w700),
                  ),
                  SizedBox(height: 5),
                  Text(
            ...
            Container(
              ...
              child: const Icon(Icons.local_dining_rounded, color: Colors.white, size: 44),
            ),
          ],
        ),
      ),
