                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const StatusPill(label: 'Client Premium', color: Colors.white),
                      ],
                    ),
                  ),
                ],
            ...
            child: ListView(
              ...
              children: [
                SurfaceCard(
                  child: Row(
                    children: const [
                      Expanded(child: _ProfileStat(label: 'Commandes', value: '24')),
                      SizedBox(height: 44, child: VerticalDivider(color: AppColors.border)),
                      Expanded(child: _ProfileStat(label: 'Note moy.', value: '4.8')),
                      SizedBox(height: 44, child: VerticalDivider(color: AppColors.border)),
                      Expanded(child: _ProfileStat(label: 'Fidelite', value: '1240 pts')),
                    ],
                  ),
                ),
                ...
                SurfaceCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      const _RecentOrder(id: '#PF-0847', date: '13 Juin 2026', amount: '2 090 DA'),
                      const _RecentOrder(id: '#PF-0831', date: '10 Juin 2026', amount: '1 350 DA'),
                    ],
                  ),
                ),
                const SizedBox(height: 16),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.receipt_long_rounded, color: AppColors.red, size: 19),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(id, style: const TextStyle(color: AppColors.text, fontWeight: FontWeight.w900)),
                Text(date, style: const TextStyle(color: AppColors.mutedText, fontSize: 11)),
              ],
            ),
          ),
          Column(
            ...
            children: [
              Text(amount, style: const TextStyle(color: AppColors.red, fontWeight: FontWeight.w900)),
              const Text('Livre', style: TextStyle(color: AppColors.success, fontSize: 11, fontWeight: FontWeight.w800)),
            ],
          ),
        ],
      ),
