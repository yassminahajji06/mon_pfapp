            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.delivery_dining_rounded, color: AppColors.red),
                ),
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 3),
                      Text('#PF-2024-0847 - Arrivee estimee 15:10', style: TextStyle(color: AppColors.mutedText, fontSize: 12)),
                    ],
                  ),
                ),
                TextButton(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('${order.time} - ${order.address}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: AppColors.mutedText, fontSize: 12)),
                        ],
                      ),
                    ),
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 3),
                        Text(order.status, style: TextStyle(color: _statusColor(order.status), fontSize: 11, fontWeight: FontWeight.w800)),
                      ],
                    ),
                  ],
                ),
