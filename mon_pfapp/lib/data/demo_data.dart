...
class DemoData {
  ...
  static const menuItems = [
    MenuItem(
      ...
      imageAsset: 'assets/menu/soupe-oignon.jpg',
      price: 450,
      rating: 4.7,
      prepTime: '15 min',
      icon: Icons.soup_kitchen_outlined,
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/foie-gras.jpg',
      price: 780,
      rating: 4.9,
      prepTime: '12 min',
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/coq-vin.jpg',
      price: 890,
      rating: 4.8,
      prepTime: '25 min',
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/boeuf-bourguignon.jpg',
      price: 1100,
      rating: 4.6,
      prepTime: '30 min',
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/ratatouille.jpg',
      price: 680,
      rating: 4.5,
      prepTime: '20 min',
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/bouillabaisse.jpg',
      price: 1200,
      rating: 4.9,
      prepTime: '35 min',
      icon: Icons.set_meal_outlined,
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/creme-brulee.jpg',
      price: 350,
      rating: 4.7,
      prepTime: '10 min',
      icon: Icons.cake_outlined,
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/tarte-tatin.jpg',
      price: 320,
      rating: 4.8,
      prepTime: '10 min',
    ...
    MenuItem(
      ...
      imageAsset: 'assets/menu/citronnade.jpg',
      price: 180,
      rating: 4.4,
      prepTime: '5 min',
