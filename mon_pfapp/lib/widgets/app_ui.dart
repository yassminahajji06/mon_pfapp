              ...
              children: [
                Row(
                  children: [
                    ...
                    if (item.popular)
                      const StatusPill(label: 'Populaire', color: AppColors.red),
                  ],
                ),
...
class StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isLight ? Colors.white.withOpacity(0.18) : color.withOpacity(0.10),
        borderRadius: BorderRadius.circular(99),
        border: isLight ? Border.all(color: Colors.white.withOpacity(0.35)) : null,
      ),
      child: Text(
        label,
        style: TextStyle(
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              if (helper != null) StatusPill(label: helper!, color: AppColors.success),
            ],
          ),
...
class AppBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tabs = [
      ...
      _BottomTab('cart', Icons.shopping_cart_rounded, 'Panier', badge: cartCount),
